...
class ReAuthSignInScreen extends StatefulWidget {
  const ReAuthSignInScreen({super.key});

  @override
  State<ReAuthSignInScreen> createState() => _ReAuthSignInScreenState();
}

class _ReAuthSignInScreenState extends State<ReAuthSignInScreen> {
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(Localization.logInAgain, style: Theme.of(context).textTheme.headlineSmall),
              const SizedBox(
                height: 32,
              ),
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      errorStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.redAccent),
                      errorMaxLines: 2,
              ...
              LcButton(
                ...
                onPressed: () async {
                  ...
                  if (emailErr && passErr) {
                    await Auth.instance().signInWithEmail(_emailController.text, _passwordController.text);
